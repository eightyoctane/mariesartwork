...
<input type="text" id="txtRecipeScale" name='recipe_scale' size=2 value='<?php echo $recipe_scale . "'>" . $LangUI->_('Servings');?>
<input type="button" id="btnScaleRecipe" value="<?php echo $LangUI->_('Refresh');?>" onclick="scaleRecipe();" class="button">
<?php } ?>

...
// ----------------------------------------------------------------------------
// Name: pervin.php
// Author: R Sean Eidemiller (mojo@halcon.cc)
...
$query = "SELECT DISTINCT vintage FROM bottle ";
$query .= "WHERE quantity>0 AND vintage!=1001 ORDER BY vintage";
...
while ($row = @mysql_fetch_row($result)) {
   ...
   $newquery = "SELECT * FROM bottle WHERE vintage=$row[0]";
...
$graph->img->SetMargin(35,30,30,45);
$graph->title->Set("Percentage (%) of Bottles per Vintage");

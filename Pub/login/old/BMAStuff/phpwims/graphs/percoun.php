...
$query = "SELECT DISTINCT country FROM bottle ";
$query .= "WHERE quantity>0 ORDER BY country";
...
while ($row = @mysql_fetch_row($result)) {
   ...
   $newquery = "SELECT * FROM bottle WHERE country=\"$row[0]\"";
...
$graph->img->SetMargin(35,30,30,95);
$graph->title->Set("Percentage (%) of Bottles per Country");

...
// Generate query and display results

$query = "SELECT DISTINCT type FROM bottle ";
$query .= "WHERE quantity>0 AND beginconsume=$year ORDER BY type";
...
$graph->title->Set("% of Bottles Entering Maturity in $year per Type");

...
$query = "SELECT DISTINCT size FROM bottle ";
$query .= "WHERE quantity>0 AND beginconsume=$year ORDER BY size";
...
while ($row = @mysql_fetch_row($result)) {
   ...
   $newquery = "SELECT * FROM bottle WHERE size=\"$row[0]\"";
...
$graph->img->SetMargin(35,30,30,65);
$graph->title->Set("% of Bottles Entering Maturity in $year per Size");

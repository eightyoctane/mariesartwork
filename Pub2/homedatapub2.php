...
$usertypemsg = array(
						...
						'<font color="#FF0000">Currently set to Dealer</font>'
					);
					
$privtypemsg = array(
						'<font color="#FF0000">Priviledge box must be set</font>',
						'<font color="#FF0000">Currently set to Visitor Privileges</font>',
						'<font color="#FF0000">Currently set to Member Privileges</font>',
						'<font color="#FF0000">Currently set to P2</font>',
						'<font color="#FF0000">Currently set to P3</font>',
						'<font color="#FF0000">Currently set to P4</font>',

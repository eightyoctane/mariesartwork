...
if(isSet($_POST['comment_content'])) {
	...
	$id=time();// Demo Use
	$u_id = $_POST['u_id'];
	$comment=mysql_real_escape_string ($_POST['comment_content']);
	$msg_id=$_POST['msg_id'];

	$lf->logMessage("comment_ajax.php: Updating comments table u_id:".$u_id." comment: ".$comment." msg_id: ".$msg_id."\n");	
	
	$sql=mysql_query("insert into comments(u_id,comment,msg_id_fk,dtandtime)values('$u_id','$comment','$msg_id',NOW())");

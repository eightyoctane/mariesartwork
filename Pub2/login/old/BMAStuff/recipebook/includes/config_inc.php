<?php
	...
	//$g_rb_debug=TRUE; // prints out all the sql calls
	...
	{
		$g_sm_adodb = $g_rb_basedir . "libs/adodb4/adodb.inc.php";
	}
	...
	*/
	...
	$autocomplete_enabled = true;		// Use Ajax for Autocomplete
	...
	$g_rb_project_version = "3.0 Beta 2"; // well not quite constant, but oh well.

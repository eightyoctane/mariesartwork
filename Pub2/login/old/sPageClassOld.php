...
class sPage {
	...
	function sPage($htmlpage) {
		...
		$_SESSION['homepage'] = $_SERVER['DOCUMENT_ROOT']."/OSA/index.php";		
		return;
	}
	...
	function clearRegionBodyContent() {
		$this->regionbody = '';
	}
	
	function addRegionBodyContent($filename) {
		$this->regionbody .= file_get_contents($filename);
	}

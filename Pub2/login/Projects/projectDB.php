<?php
	...
	*/
	...
	$query = "CREATE TABLE IF NOT EXISTS projects (
				pjid SMALLINT(5) unsigned not null primary key auto_increment,
				istatus VARCHAR(10) not null,
				pjname VARCHAR(40) not null,
	...
	if(! $result) {
		$msg = "projects table creation failed";
	} else {
		$msg = "projects table creation succeeded";
	}

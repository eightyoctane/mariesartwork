...
if (! isset($_POST['submitbutton'])){
	...
	$text = $rf->renderRformTextD("FIRST LAST or FIRST MI LAST",NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL, $tboxhtml, $pboxhtml, NULL, NULL, $rf->getCheckBox(),$vd);
	$gp->addBodyText($text);
	$gp->renderPage();

...
INSERT INTO `tcomments` (`com_id`, `comment`, `msg_id_fk`, `uid_fk`, `ip`, `created`) VALUES
...
INSERT INTO `tmessages` (`msg_id`, `message`, `uid_fk`, `ip`, `created`) VALUES
...
INSERT INTO `tusers` (`uid`, `username`, `password`, `email`) VALUES

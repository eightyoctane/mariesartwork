...
$regionandheaderfull = $rootlocation.$staticcontentloc."bma_RegionAndHeader.htm";
$simpleregion = "bma_RegionSimple.htm";
$regionandheadersplitfull = $rootlocation.$staticcontentloc."bma_RegionAndHeaderSplit.htm";

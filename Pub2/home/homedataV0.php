...
$homelanding = array( 
			$utype['nobody'] => "login.php",	
			$utype['visitor'] => "login/bmarv.php",
			$utype['resident'] => "login/por.php",
...
$adminauthinfo = array( 0 => $utype['resident'] ,
                        1 => $upriv['webadmin'],
                        2 => $homelocationpart.$homelocationsub.$homelanding[$utype['resident']],
                        3 => $homelandingfull[$utype['resident']],
                        4 => $rootlocation."login/htmlfiles/adminbody.htm");



												
					
define('ROOTLOCATION',$rootlocation);
define('HOMELOCATION',$homelocationpart.$homelocationsub);
define('ERRORLOG', $rootlocation.$errorlog);
